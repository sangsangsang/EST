...
<c:set var="ctx" value="${pageContext.request.contextPath}"/>
   ...
   <form action="fashion&beauty-list" method="GET">
         <div id ="box1" class="hc vc">
           <nav id ="category-form">
            ...
            <a href=""><img src="${ctx}/content/images/foodLetter.png"
                     alt="food" /></a> --%>
             <li><img src="${ctx}/content/images/fashion&beauty.png"/></li>
         ...
         <nav id = "rating-menu">
            ...
            <ul>
               <li><a href="fashion&beauty-list?c=5"><img src="${ctx}/content/images/5.png"
                     alt="별5개" /></a></li>
               <li><a href="fashion&beauty-list?c=4"><img src="${ctx}/content/images/4.png"
                     alt="별4개" /></a></li>
               <li><a href="fashion&beauty-list?c=3"><img src="${ctx}/content/images/3.png"
                     alt="별3개" /></a></li>
               <li><a href="fashion&beauty-list?c=2"><img src="${ctx}/content/images/2.png"
                     alt="별2개" /></a></li>
               <li><a href="fashion&beauty-list?c=1"><img src="${ctx}/content/images/1.png"
                     alt="별1개" /></a></li>
