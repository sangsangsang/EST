...
<c:set var="ctx" value="${pageContext.request.contextPath}"/>
   ...
   <h1 class="hidden">리뷰리스트</h1> 
         ...
         <nav id = "rating-menu">
            ...
            <ul>
               <li><a href="search-review_list?c=5"><img src="${ctx}/content/images/5.png"
                     alt="별5개" /></a></li>
               <li><a href="search-review_list?c=4"><img src="${ctx}/content/images/4.png"
                     alt="별4개" /></a></li>
               <li><a href="search-review_list?c=3"><img src="${ctx}/content/images/3.png"
                     alt="별3개" /></a></li>
               <li><a href="search-review_list?c=2"><img src="${ctx}/content/images/2.png"
                     alt="별2개" /></a></li>
               <li><a href="search-review_list?c=1"><img src="${ctx}/content/images/1.png"
                     alt="별1개" /></a></li>
